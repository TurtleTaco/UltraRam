...
#ifndef __sum_io_sitodp_32scud__HH__
#define __sum_io_sitodp_32scud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(sum_io_sitodp_32scud) {
    ...
    SC_CTOR(sum_io_sitodp_32scud):  ACMP_sitodp_U ("ACMP_sitodp_U") {

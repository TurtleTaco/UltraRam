...
entity sum_io_empty_6_ram is 
   generic(
  -- Common module parameters
       MEMORY_SIZE        : integer := 120000;
  ...
  -- Port A module parameters
       WRITE_DATA_WIDTH_A : integer := 6;
       READ_DATA_WIDTH_A  : integer := 6;
       BYTE_WRITE_WIDTH_A : integer := 6;
       ADDR_WIDTH_A       : integer := 15;
...
architecture rtl of sum_io_empty_6_ram is 
...
architecture arch of sum_io_empty_6 is
    component sum_io_empty_6_ram is
        port (
            clka : IN STD_LOGIC;
            rsta : IN STD_LOGIC;
...
begin
    sum_io_empty_6_ram_U :  component sum_io_empty_6_ram
    port map (
        clka => clk,
        rsta => reset,
        addra => address0,

...
`timescale 1ps/1ps
module sum_io_empty_6_ram # (

  // Common module parameters
  parameter integer                 MEMORY_SIZE        = 120000,
...
endmodule : sum_io_empty_6_ram

`timescale 1 ns / 1 ps
module sum_io_empty_6(
    reset,
    clk,
    address0,
    ce0,
...
sum_io_empty_6_ram sum_io_empty_6_ram_U(
    .clka( clk ),
    .rsta( reset ),
    .addra( address0 ),
    .ena( ce0 ),
